...
public class HotelTest {
	...
	private static void testGetReceipts() {
		System.out.println("\n-->testGetReceipts()");
		Hotel hotel = indigo();
		System.out.println(hotel.getReceipts());
	}
	...
	private static void testGetSortedRooms() {
		System.out.println("\n-->testGetSortedRooms()");
		Hotel hotel = getUnsortedRooms();
		System.out.println("Hotel Rooms before sorting:");
		System.out.println(hotel);
		
		ArrayList<Room> sortedRooms = hotel.getSortedRooms();
		System.out.println("Sorted Rooms:");
		int i = 1;
		for(Room r : sortedRooms) {
			System.out.println(String.format("%d. %s", i++, r));
		}
		System.out.println();
		
		System.out.println("Hotel Rooms after sorting:");
		System.out.println(hotel);
	}
	...
	private static Hotel getUnsortedRooms() {
		Hotel hotel = new Hotel("Marriot");
		Room r1 = new RegularRoom(401); //--> $100.00
		Room r2 = new RegularRoom(201, 2, 2); //--> $240.00
		Room r3 = new DeluxeRoom(501, 3, 3); //--> $540.00
		Room r4 = new DeluxeRoom(101, 3, 2); //--> $360.00
		Room r5 = new DeluxeRoom(301, 2, 2); //--> $340.00
